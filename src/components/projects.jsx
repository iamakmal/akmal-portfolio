...
function Projects() {
  return (
    ...
    <Card sx={{ maxWidth: 800, borderRadius: '3%', margin: '20px', padding: '10px' }}>
      ...
      <a href="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7086013694580568064?compact=1" target="_blank" rel="noopener noreferrer"><Button size="large">Demo</Button></a>
      </CardActions>
    </Card>
    </Grid>
