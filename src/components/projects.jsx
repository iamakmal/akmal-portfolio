    ...
    <>
      <section id="projects">
        ...
        <Box
          ...
          gap={2}
        >
          <Button variant="contained" startIcon={<All />} color='secondary' sx={{ borderRadius: 10 }} onClick={() => setSelectedType('all')}>All</Button>
          <Button variant="contained" startIcon={<Web />} sx={{ borderRadius: 10 }} onClick={() => setSelectedType('web')}>Web</Button>
          <Button variant="contained" startIcon={<Phone />} color='error' sx={{ borderRadius: 10 }} onClick={() => setSelectedType('mobile')}>Mobile</Button>
        </Box>
        <Grid
          container
          spacing={2}
